...
Page({
  ...
  // 查看详情包括评论
  clickRefuseDetail: function (e) {
    let repair_id = e.currentTarget.dataset.id;
    let processLog_id = e.currentTarget.dataset.processlogId;
    wx.navigateTo({
      url: '/pages/refuseDetail/refuseDetail?repair_id=' + repair_id + '&processLog_id=' + processLog_id,
    })
  },
